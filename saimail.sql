CREATE DATABASE  IF NOT EXISTS `saimail` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `saimail`;
...
INSERT INTO `address` VALUES (15,'','','','','New Jersey','USA','USA','',0,0,NULL);
...
CREATE TABLE `file_info` (
  `file_info_id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `user_info` VALUES (4,'venkypk@saimail.com','sai','Venky','Kullampalle','112233445566','SA','APPROVED',0,NULL,NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2012-10-04 14:12:50
